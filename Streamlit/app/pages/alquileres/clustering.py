...
def clustering_page():
    ...
    cursor.execute("""
            CREATE TABLE IF NOT EXISTS alquiler_clusters (
    ...
    for _, row in df2.iterrows():
        cursor.execute("""
                INSERT INTO alquiler_clusters (precio, antiguedad, conservacion, latitud, longitud, piscina, baños, chimenea, habitaciones, superficie, superficie_util, garaje, provincia, planta, orientacion, cluster)
