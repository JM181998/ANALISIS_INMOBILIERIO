...
def eda_page():
    ...
    # Filtrar outliers de precio y superficie por separado
    #df_filtrado_compras_precio = filtrar_outliers_precio(df)
    #df_filtrado_compras = filtrar_outliers_superficie(df_filtrado_compras_precio)
